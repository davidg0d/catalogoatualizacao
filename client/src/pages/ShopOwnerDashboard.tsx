          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Adicione um banner para sua loja
                </CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col items-center">
                {store?.bannerUrl ? (
                  <div className="mb-4">
                    <div className="w-full h-[300px] rounded overflow-hidden bg-gray-100">
                      <img
                        src={store.bannerUrl}
                        alt="Banner da loja"
                        className="w-full h-full object-cover"
                    ...
                    <Button 
                      ...
                      onClick={async () => {
                        try {
                          await apiRequest("PATCH", "/api/store", { bannerUrl: null });
                          queryClient.setQueryData(["/api/store"], (oldData: any) => ({
                            ...oldData,
                            bannerUrl: null
                          }));
                  ...
                  <div className="mb-4 w-full h-[300px] rounded bg-gray-100 flex items-center justify-center">
                    <div className="text-center">
                      <Store className="w-12 h-12 text-gray-400 mx-auto mb-2" />
                      <p className="text-sm text-gray-500">Tamanho recomendado: 1200x300 pixels</p>
                    </div>
                  </div>
                )}
                <label
                    ...
                    onChange={async (e) => {
                      ...
                      if (files && files.length > 0) {
                        ...
                        if (file.size > 5 * 1024 * 1024) {
                          toast({
                            title: "Erro",
                            description: "O arquivo é muito grande. Máximo de 5MB.",
                            variant: "destructive",
                          });
                          return;
                        }
