...
export class MemStorage implements IStorage {
  ...
  async createStore(store: InsertStore): Promise<Store> {
    ...
    const newStore: Store = {
      ...
      bannerUrl: store.bannerUrl || "/images/default-store-banner.jpg",
      active: true,
      createdAt: new Date(),
      updatedAt: new Date(),
...
const { DATABASE_URL = "postgres://default:YmZE7ZzFTtCN@ep-late-mud-a4o8pg7o.us-east-1.aws.neon.tech/verceldb?sslmode=require" } = process.env;
